        ...
        <div className="p-grid">
            <div className="p-col-12">
                <div className="card">
                    ...
                    <FullCalendar events={events} eventClick={eventClick} initialDate="2021-02-01" initialView='dayGridMonth' plugins={[dayGridPlugin, timeGridPlugin, interactionPlugin]}
