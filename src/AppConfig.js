                ...
                <div className="layout-config-panel p-d-flex p-flex-column">
                    ...
                    <div className="layout-config-options p-p-3">
                        ...
                        <div className="p-d-flex p-ai-center">
                            ...
                            {
                                scales.map((s, i) => {
                                    return <i key={i} className={classNames('pi pi-circle-on p-m-1 scale-icon', { 'scale-active': s === scale })}></i>
                                })
                            }
                        ...
                        <div className="p-d-flex">
                            <div className="p-d-flex p-flex-column">
                                <div className="p-d-flex p-ai-center">
                                    ...
                                    <label htmlFor="static" className={classNames({ 'p-ml-2': !isRTL, 'p-mr-2': isRTL })}>Static</label>
                                </div>
                                <div className="p-d-flex p-ai-center p-mt-3">
                                    ...
                                    <label htmlFor="horizontal" className={classNames({ 'p-ml-2': !isRTL, 'p-mr-2': isRTL })}>Horizontal</label>
                                </div>
                            </div>
                            <div className={classNames('p-d-flex p-flex-column', { 'p-ml-4': !isRTL, 'p-mr-4': isRTL })}>
                                <div className="p-d-flex p-ai-center">
                                    ...
                                    <label htmlFor="overlay" className={classNames({ 'p-ml-2': !isRTL, 'p-mr-2': isRTL })}>Overlay</label>
                                </div>
                                <div className="p-d-flex p-ai-center p-mt-3">
                                    <RadioButton id="slim" name="menuMode" value="slim" checked={props.menuMode === 'slim'} onChange={(e) => props.onMenuModeChange(e.value)} />
                                    <label htmlFor="slim" className={classNames({ 'p-ml-2': !isRTL, 'p-mr-2': isRTL })}>Slim</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-d-flex">
                            <div className="p-d-flex p-ai-center">
                                ...
                                <label htmlFor="top" className={classNames({ 'p-ml-2': !isRTL, 'p-mr-2': isRTL })}>Top</label>
                            </div>
                            <div className={classNames('p-d-flex p-ai-center', { 'p-ml-4': !isRTL, 'p-mr-4': isRTL })}>
                                ...
                                <label htmlFor="bottom" className={classNames({ 'p-ml-2': !isRTL, 'p-mr-2': isRTL })}>Bottom</label>
                            </div>
                            <div className={classNames('p-d-flex p-ai-center', { 'p-ml-4': !isRTL, 'p-mr-4': isRTL })}>
                                ...
                                <label htmlFor="both" className={classNames({ 'p-ml-2': !isRTL, 'p-mr-2': isRTL })}>Both</label>
                            </div>
                        </div>
                        ...
                        <div className="p-formgroup-inline">
                            <div className="p-d-flex">
                                <div className="p-d-flex p-ai-center">
                                    ...
                                    <label htmlFor="input_outlined" className={classNames({ 'p-ml-2': !isRTL, 'p-mr-2': isRTL })}>Outlined</label>
                                </div>
                                <div className={classNames('p-d-flex p-ai-center', { 'p-ml-4': !isRTL, 'p-mr-4': isRTL })}>
                                    ...
                                    <label htmlFor="input_filled" className={classNames({ 'p-ml-2': !isRTL, 'p-mr-2': isRTL })}>Filled</label>
                                </div>
                            </div>
                        </div>
